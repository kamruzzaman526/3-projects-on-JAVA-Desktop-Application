 ...
 * @author hp
 */
public class U_Emp extends javax.swing.JFrame {

    /**
     * Creates new form U_Emp
     */
    public U_Emp() {
        initComponents();
        table_update();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(U_Emp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
